...
public:
	CTableData()
	{
		swprintf(id, L"ID_NONE");
		wcscpy(str, L"");
	}

	CTableData(int iCnt)
	{
		swprintf(id, L"ID_NONE%d", iCnt);
		wcscpy(str, L"");
	}

	CTableData(Nave::String strID, int iCnt)
	{
		swprintf(id, L"%s%d", strID.c_str(), iCnt);
		wcscpy(str, L"");
	}
...
extern std::vector<CTableData> g_tableData;

extern Nave::String	g_strID;
////////////////////////////////////////////////////////////////////////////
