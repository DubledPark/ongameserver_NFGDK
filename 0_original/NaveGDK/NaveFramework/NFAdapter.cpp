...
namespace NaveFramework { 
	...
	NFAdapter::~NFAdapter()
	{
		...
		_DELETE( m_pAllowedAdapterFormatList );
	}
	...
	//-----------------------------------------------------------------------------
	HRESULT NFAdapter::EnumerateDevices( D3DAdapterInfo* pAdapterInfo, 
	...
	//-----------------------------------------------------------------------------
	HRESULT NFAdapter::EnumerateDeviceCombos( D3DDeviceInfo* pDeviceInfo, 
												CArrayList* pAdapterFormatList )
	{
	...
	//-----------------------------------------------------------------------------
	void NFAdapter::BuildDepthStencilFormatList( D3DDeviceCombo* pDeviceCombo )
	{
	...
	//-----------------------------------------------------------------------------
	void NFAdapter::BuildMultiSampleTypeList( D3DDeviceCombo* pDeviceCombo )
	{
	...
	//       multisample types.
	//-----------------------------------------------------------------------------
	void NFAdapter::BuildDSMSConflictList( D3DDeviceCombo* pDeviceCombo )
	{
	...
	//       and app to the given D3DDeviceCombo.
	//-----------------------------------------------------------------------------
	void NFAdapter::BuildVertexProcessingTypeList( D3DDeviceInfo* pDeviceInfo, 
	...
	//-----------------------------------------------------------------------------
	void NFAdapter::BuildPresentIntervalList( D3DDeviceInfo* pDeviceInfo, 
													D3DDeviceCombo* pDeviceCombo )
	{
		const UINT piArray[] = { 
