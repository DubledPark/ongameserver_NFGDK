...
namespace NaveServer {
	...
	NFServerLink::NFServerLink(VOID)
	{
	}
	...
	{	
		...
		if(!NFConnection::Create(dwIndex, hIOCP, NULL, pPacketPool, nMaxBuf))
		{
			OnConnect(FALSE);
	...
	// [4]DATE : 2003년 10월 24일									//
	//////////////////////////////////////////////////////////////////
	INT NFServerLink::DispatchPacket(LPOVERLAPPEDPLUS lpOverlapPlus)
	{
