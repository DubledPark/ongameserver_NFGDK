///////////////////////////////////////////////////////////////////////////////
//	Filename:	NaveWindowUI.cpp
//	Coder	:	Edith (Edithe@chollian.net) 
//	Comp.	:	EDITH
//	Compiler:	Visual C++ 6.0
//	Date	:	2003-05-01오후 2:17:08
//	Title	:	Server의 기본BASE UI
///////////////////////////////////////////////////////////////////////////////
...
namespace NaveTest {
	...
	VOID UIWindow::ResizeWindows( ) 
	{
		ResizeEdit(m_hMainWnd);
		ResizeLogView(m_hMainWnd);
	}
	...
	LRESULT UIWindow::MsgProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
	{
		...
		// ListView 키보드 입력.
		case WM_VKEYTOITEM :
			return OnVkeyToItem(hWnd, uMsg, wParam, lParam);
	...
	BOOL UIWindow::Init(HINSTANCE hInstance, int nCmdShow, WCHAR* AppName, WCHAR* Icon)
	{
		// 윈도우의 생성
		WNDCLASSEX wcex;
		...
		// 윈도우 생성
		m_hMainWnd = CreateWindowEx(WS_EX_WINDOWEDGE, AppName, AppName, WS_OVERLAPPEDWINDOW,
		...
		InitEdit(m_hMainWnd, m_hFont);
		InitLogView(m_hMainWnd, m_hFont);

		Nave::NFLog::SetLogHandel(g_hListWnd);
//		Nave::NFLog::EnableLogFile(true);
		...
		// EditBox에 포커스 주기
		SetFocus(g_hEditWnd);								// Sets Keyboard Focus To The UIWindow
